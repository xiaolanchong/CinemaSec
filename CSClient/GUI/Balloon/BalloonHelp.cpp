...
CSize CBalloonHelp::DrawHeader(CDC* pDC, bool bDraw)
{
   ...
   if ( m_unOptions & unSHOW_CLOSE_BUTTON )
   {
      ...
      sizeHdr.cy = 
		  ...
		  std::max<int>
#endif
		  (sizeHdr.cy, ::GetSystemMetrics(SM_CYSIZE));
      if (bDraw)
...
#else
   regionRound.CreateRoundRectRgn(ptTopLeft.x,ptTopLeft.y,ptBottomRight.x,ptBottomRight.y,BALLOON_X_CORNER, BALLOON_Y_CORNER);
#endif
