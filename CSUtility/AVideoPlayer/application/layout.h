...
//-------------------------------------------------------------------------------------------------
/** \brief Function returns nonzero if the layout is valid. */
//-------------------------------------------------------------------------------------------------
template< class IMAGE >
bool ready( const IMAGE * p = 0 ) const
{
  return (m_bReady && ((p == 0) || ((p->width() == m_imgW) && (p->height() == m_imgH))));
}
