...
//-------------------------------------------------------------------------------------------------
/*
void IMessage::Print( __int32 messageType, const TCHAR * szMessage )
{
...
/** \brief Function prints a wide-char message.
  ...
  \param  szMessage    the message to print. */
//-------------------------------------------------------------------------------------------------
void IMessage::PrintW( __int32 messageType, const wchar_t * szMessage )
{
  if (szMessage != 0)
  {
    switch (messageType)
...
/** \brief Function prints an ANSI-char message.
  ...
  \param  szMessage    the message to print. */
//-------------------------------------------------------------------------------------------------
void IMessage::PrintA( __int32 messageType, const char * szMessage )
{
  if (szMessage != 0)
  {
    switch (messageType)
